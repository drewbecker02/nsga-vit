...
parser.add_argument('--conv_stem', action='store_true', default=False, help='conv stem')
parser.add_argument('--conv_stem_layers', default=5, type=int, help='# layers in the conv stem')
...
def main():
    ...
    if args.net_type == 'micro':
        ...
        net = Network(args.init_channels, num_classes=10, layers=args.layers,
                         auxiliary=args.auxiliary, genotype=genotype, patchify=args.patchify,
                         stem_layers=args.conv_stem_layers)
