...
def convert(bit_string):
    ...
    norm_gene = convert_cell(bit_string)
    return [norm_gene,]
...
#     print(decode(convert(bit_string1)))
    ...
    cell_bit_string = [0, 0, 0, 1,
                       9, 2, 0, 2,
                       1, 3, 0, 3,
                       9, 4, 0, 4,
                       1, 5, 0, 5]
    print(decode_cell(convert_cell(cell_bit_string)))
