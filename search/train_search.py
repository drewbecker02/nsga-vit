...
def main(genome, epochs, search_space='micro',
         save='Design_1', expr_root='search', seed=0, gpu=0, init_channels=256,
         layers=2, auxiliary=False, cutout=False, drop_path_prob=0.0, final_combiner = 'concat'):
    ...
    # HERE is where the network is built from the genome
    ...
    if search_space == 'micro':
        ...
        model = Network(init_channels, CIFAR_CLASSES, layers, auxiliary, genotype, 
                        patchify=True, final_combiner = final_combiner)
...
if __name__ == "__main__":
    # ViT = [[[[10, 0], [1, 1]], [[2, 2], [1, 2]], [[10, 3], [1, 3]], [[2, 4], [1, 4]]]]
    ViT = [[ [[0, 1], [0, 0]],[[9, 2], [0, 2]], [[11, 3], [0, 3]],[[9, 4], [0, 4]], [[11, 5],[0, 5]] ]]
    conViT = [[[[5, 0], [3, 0]], [[4, 1], [6, 1]], [[11, 2], [3, 1]], [[3, 2], [10, 2]]]]
    
    
    start = time.time()
    print(main(genome=ViT, epochs=25, save='ViT', seed=1, init_channels=256,
               layers=2,auxiliary=False, cutout=False, drop_path_prob=0.0))
